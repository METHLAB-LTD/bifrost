use ethereum_bridge_primitives::Verifier as VerifierConfig;
...
use crate::{
	mock::{
		...
		mock_verifier::{MaxHeadersForNumber, Origin, Test, Verifier},
		mock_verifier_with_pow, new_tester, new_tester_with_config, receipt_root_and_proof,
